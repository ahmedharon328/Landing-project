...
// CreateElement firstSection
const firstSection = document.createElement('li');
firstSection.innerHTML ="<a>Section 1</a>";
const selectors = document.getElementById('navbar__list');
selectors.appendChild(firstSection);

//createing second section
const secondSection = document.createElement('li');
secondSection.innerHTML="<a>Section 2</a>";
selectors.appendChild(secondSection);

// creating thrid section
const thirdSection = document.createElement('li');
thirdSection.innerHTML="<a>Section 3</a>";
selectors.appendChild(thirdSection);

//creating Fourth section
const fourthSection = document.createElement('li');
fourthSection.innerHTML ="<a>Section 4</a>";
selectors.appendChild(fourthSection);
